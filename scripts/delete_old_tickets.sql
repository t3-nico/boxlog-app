...
-- 現在のチケット数を確認
SELECT 'Before deletion - plans:' as info, COUNT(*) as count FROM plans;
...
-- 削除後の件数を確認
SELECT 'After deletion - plans:' as info, COUNT(*) as count FROM plans;
SELECT 'After deletion - Sessions:' as info, COUNT(*) as count FROM sessions;

-- 残っているチケットを確認
SELECT * FROM plans ORDER BY created_at DESC LIMIT 10;
