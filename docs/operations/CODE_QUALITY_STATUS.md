...
| `CalendarDragSelection.tsx` | 707  | 要分割     |
| `config/error-patterns.ts`  | 704  | 設定OK     |
| `TagsSidebar.tsx`           | 651  | 要分割     |
| `TagInspector.tsx`          | 622  | 要分割     |
| `PlanInspectorContent.tsx`  | 611  | 要分割     |
...
### Phase 2: コード構造改善（次回対応）

- [ ] CalendarDragSelection.tsx 分割（707行）
- [ ] TagsSidebar.tsx 分割（651行）
- [ ] TagInspector.tsx 分割（622行）
- [ ] PlanInspectorContent.tsx 分割（611行）
