...
-- Session関連テーブル・機能の削除
-- 作成日: 2024-10-30
-- 理由: Ticket/Session統合の複雑さを解消、必要時に再実装
-- ========================================
...
DROP TRIGGER IF EXISTS trigger_update_ticket_hours_on_session_change ON sessions;
...
-- ========================================
-- 4. Ticketsテーブルのactual_hoursカラム削除
-- ========================================
