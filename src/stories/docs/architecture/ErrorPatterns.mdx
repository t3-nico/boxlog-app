...
<Meta title="Docs/Architecture/Error Patterns" />

# エラーパターン辞書

Dayoptの統一エラー管理システム。エラーコード体系、自動復旧、ユーザー通知、Sentry連携を提供する。
...
- [ErrorBoundary](?path=/docs/docs-guides-errorboundary--docs) — 4段階自動復旧システム
