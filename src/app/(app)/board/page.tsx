    ...
    <div className={spacing.page.default}>
      <div className={layout.singleColumn}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* TODO Column */}
          <div className={`${colors.background.elevated} ${componentRadius.card.base} ${patterns.card.default} ${spacing.padding.md}`}>
            <h2 className={`${typography.heading.h3} ${colors.text.primary} ${spacing.margin.sm}`}>Todo</h2>
            <div className={spacing.stack.sm}>
              <div className={`${colors.background.subtle} ${spacing.padding.sm} ${componentRadius.card.nested} border-l-4 ${colors.border.info}`}>
          ...
          <div className={`${colors.background.elevated} ${componentRadius.card.base} ${patterns.card.default} ${spacing.padding.md}`}>
            ...
            <div className={spacing.stack.sm}>
              <div className={`${colors.background.subtle} ${spacing.padding.sm} ${componentRadius.card.nested} border-l-4 ${colors.border.warning}`}>
          ...
          <div className={`${colors.background.elevated} ${componentRadius.card.base} ${patterns.card.default} ${spacing.padding.md}`}>
            ...
            <div className={spacing.stack.sm}>
              <div className={`${colors.background.subtle} ${spacing.padding.sm} ${componentRadius.card.nested} border-l-4 ${colors.border.success}`}>
