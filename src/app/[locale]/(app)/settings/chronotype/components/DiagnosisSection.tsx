...
export const DiagnosisSection = memo(
  ({
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center gap-3">
            <button
              ...
              className="rounded-md border border-border bg-card px-4 py-2 text-sm font-medium text-muted-foreground transition-colors hover:bg-muted"
            >
              もう一度診断
            </button>
            <button
    ...
    // 質問表示
    const question =
      currentQuestion >= 0 && currentQuestion < diagnosisQuestions.length ? diagnosisQuestions[currentQuestion] : null
    ...
    return (
      <div>
        ...
        <div className="mb-6">
          <h3 className="mb-4 text-2xl font-bold text-neutral-900 dark:text-neutral-100">{question?.question || ''}</h3>
