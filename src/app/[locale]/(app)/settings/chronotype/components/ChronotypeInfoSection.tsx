      ...
      <div className="prose prose-sm max-w-none">
        <div className="space-y-4 text-neutral-600 dark:text-neutral-400">
          ...
          <div className="my-6 grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="rounded-lg border border-border bg-yellow-50 p-4 dark:bg-yellow-950">
            ...
            <div className="rounded-lg border border-border bg-blue-50 p-4 dark:bg-blue-950">
            ...
            <div className="rounded-lg border border-border bg-green-50 p-4 dark:bg-green-950">
