    ...
    <div className="bg-background flex min-h-screen flex-col items-center justify-center p-4">
      <div className="text-center">
        ...
        <button
          ...
          className="bg-primary text-primary-foreground hover:bg-primary-hover inline-flex items-center justify-center rounded-lg px-6 py-3 font-normal transition-colors"
        >
          再読み込み
        </button>
      </div>
