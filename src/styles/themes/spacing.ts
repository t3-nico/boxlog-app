...
import { primitiveSpacing } from './design-tokens'

// 基本スペーシング（デザイントークンから取得）
export const spacing = Object.entries(primitiveSpacing).reduce((acc, [key, value]) => {
  acc[key as keyof typeof primitiveSpacing] = value.rem
  return acc
}, {} as Record<keyof typeof primitiveSpacing, string>)
