          ...
          <div className="flex items-start gap-6">
            ...
            <div className="group relative">
              {uploadedAvatar ? (
                ...
                <label
                  htmlFor="avatar-upload"
                  className="border-border bg-muted hover:bg-state-hover flex h-20 w-20 cursor-pointer items-center justify-center rounded-full border-2 border-dashed transition-colors"
                >
