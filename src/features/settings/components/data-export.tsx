    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-muted-foreground mt-1 text-sm">
          {t('settings.account.dataExport.description')}
        </p>
      </div>

      <div className="border-border bg-surface-container/50 rounded-xl border p-4">
        <h4 className="mb-2 text-sm font-medium">
          {t('settings.account.dataExport.includedData')}
        </h4>
      ...
      <div className="flex justify-start">
        <Button onClick={handleExport} disabled={isExporting} variant="outline">
          ...
          {isExporting
            ? t('settings.account.dataExport.exporting')
            : t('settings.account.dataExport.button')}
        </Button>
      </div>
