            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-border bg-white px-3 py-2 text-sm text-gray-900 focus:border-transparent focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
            ...
            {tags.length === 0 ? (
              ...
              <div className="max-h-64 space-y-2 overflow-y-auto">
                {tags.map((tag) => (
                  <div
                    key={tag.id}
                    className="flex items-center gap-3 rounded-lg border border-border bg-gray-50 p-3 dark:bg-gray-700"
                  >
                    {editingTag === tag.id ? (
                      <>
                        {/* Edit Mode */}
                        <div className="flex-1 space-y-2">
                          <input
                            ...
                            className="w-full rounded border border-border bg-white px-2 py-1 text-sm text-gray-900 dark:bg-gray-800 dark:text-white"
