...
export const CustomDragLayer = () => {
  ...
  return (
    ...
    >
      <div className="bg-primary/90 text-primary-foreground rounded-md p-2 shadow-2xl border-2 border-primary">
        <div className="text-sm font-medium truncate">{item.event.title}</div>
      </div>
    </div>
  )
}
