...
import { TIME_COLUMN_WIDTH, GRID_BACKGROUND, GRID_BORDER } from '../../constants/grid.constants'
...
export const TimeColumn = memo<TimeColumnProps>(function TimeColumn({
  ...
  return (
    <div
      className={`sticky left-0 ${GRID_BACKGROUND} ${GRID_BORDER} border-r z-10 ${className}`}
      style={{
