...
export const calendarStyles: CalendarStyles = {
  ...
  layout: {
    ...
    scrollbar: 'scrollbar-thin scrollbar-thumb-gray-400/50 scrollbar-track-white dark:scrollbar-track-gray-900/30 dark:scrollbar-thumb-gray-500/40',
