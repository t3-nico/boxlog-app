...
export function useInspectorSaveClose({
  ...
  }, [t, updatePlan, closeInspector, createPlan, setplanTags, hasTagChanges, utils, selectedTagIdsRef]);
  ...
  const cancelAndClose = useCallback(() => {
    ...
    closeInspector();
  }, [clearPendingChanges, closeInspector, planId, updateTagsInCache, hasTagChanges, originalTagIdsRef]);
