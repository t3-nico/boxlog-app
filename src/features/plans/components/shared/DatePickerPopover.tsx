  ...
  return (
    <MiniCalendar
      ...
      popoverTrigger={
        <button
          type="button"
          className="hover:bg-state-hover text-muted-foreground hover:text-foreground data-[state=selected]:text-foreground inline-flex h-8 items-center justify-center rounded-md px-2 text-sm transition-colors"
