 ...
 * @example
 * ```tsx
 * const { groupBy, setGroupBy, toggleGroupCollapse } = useInboxGroupStore()
 *
 * // ステータスでグループ化
 * setGroupBy('status')
 *
 ...
 * ```
 */
export const useInboxGroupStore = create<InboxGroupState>()(
  devtools(
    (set, get) => ({
      groupBy: null,
