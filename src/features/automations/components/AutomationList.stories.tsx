...
const mockAutomations: Automation[] = [
  {
    id: '1',
    name: 'エントリ更新時にレコードを自動作成',
    is_enabled: true,
    trigger_type: 'entry.updated',
  ...
  },
  {
    ...
    name: '新規エントリ作成時に通知',
    is_enabled: false,
    trigger_type: 'entry.created',
    conditions: [],
    action_type: 'send_notification',
    action_config: {
      title: '新規エントリ',
      message: '新しいエントリが追加されました',
    },
    trigger_count: 7,
  ...
  },
  {
    ...
    name: '高充実度のエントリ通知',
    is_enabled: true,
    trigger_type: 'entry.past',
    conditions: [{ field: 'fulfillment', operator: 'gte', value: '3' }],
    action_type: 'send_notification',
