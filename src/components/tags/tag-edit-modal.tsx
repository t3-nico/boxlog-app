        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3 py-1.5 text-sm font-medium text-white bg-red-600 border border-transparent rounded hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              削除する
            </button>
            <button
              onClick={onCancel}
              className="px-3 py-1.5 text-sm font-medium text-red-700 dark:text-red-400 bg-transparent border border-red-300 dark:border-red-600 rounded hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
            >
              キャンセル
            </button>
          </div>
