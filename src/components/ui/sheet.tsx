...
>(({ className, ...props }, ref) => {
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        'data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 bg-overlay fixed inset-0 z-[150] motion-reduce:animate-none',
        className,
      )}
      {...props}
    />
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          'bg-card text-card-foreground fixed z-[150] flex flex-col gap-4 shadow-xl transition ease-in-out motion-reduce:transition-none',
