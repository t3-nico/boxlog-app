...
>) {
  ...
  return (
    <Headless.ComboboxOption
      ...
      className={clsx(
        // Basic layout
        'group/option grid w-full cursor-default grid-cols-[1fr_--spacing(5)] items-baseline gap-x-2 rounded-lg py-3 pr-2 pl-4 sm:grid-cols-[1fr_--spacing(4)] sm:py-2 sm:pr-2 sm:pl-3',
        // Typography
