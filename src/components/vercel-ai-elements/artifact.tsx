...
export const Artifact = ({ className, ...props }: ArtifactProps) => (
  <div
    className={cn('bg-background flex flex-col overflow-hidden rounded-lg border shadow-sm', className)}
    {...props}
  />
)
...
export const ArtifactHeader = ({ className, ...props }: ArtifactHeaderProps) => (
  <div className={cn('bg-muted/50 flex items-center justify-between border-b px-4 py-3', className)} {...props} />
)
