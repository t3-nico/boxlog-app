...
import type { Toast, ToastOptions, ToastPosition, ToastType } from './types'
...
export const useToastStore = create<ToastStore>((set, get) => ({
  ...
  addToast: (type, title, options = {}) => {
    ...
    const toast: Toast = {
      ...
      duration:
        options.duration ??
        (Object.prototype.hasOwnProperty.call(DEFAULT_DURATION, type)
          ? DEFAULT_DURATION[type as keyof typeof DEFAULT_DURATION]
          : 3000),
