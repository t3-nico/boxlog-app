 ...
 * 📊 グループ固有の影響度計算
 */
export function calculateGroupSpecificImpact(change: BreakingChange, group: AffectedGroup): ImpactLevel {
  // グループごとの影響度調整ロジック
 ...
 * 🛡️ グループ固有の軽減策取得
 */
export function getGroupSpecificMitigation(change: BreakingChange, _group: AffectedGroup): string[] {
